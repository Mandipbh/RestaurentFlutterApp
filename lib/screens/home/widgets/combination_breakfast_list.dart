...
class CombinationBreakfastList extends ConsumerWidget {
  ...
  const CombinationBreakfastList({
    super.key,
    required this.breakfastAsync,
    required this.user,
  });
        ...
        child: breakfastAsync.when(
          data: (foodItems) {
            if (foodItems.isEmpty) {
              return Center(
                  child: Text('No breakfast items available',
            ...
            if (filteredItems.isEmpty && searchQuery.isNotEmpty) {
              return Padding(
                ...
                child: Center(
                    child: Text('No matching breakfast items found',
                        style: TextStyle(color: Colors.white))),
              );
            }
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isInCart = cart.any(
                    (item) => item['combination_breakfast_id'] == food['id']);
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FoodDetailScreens(
                            food: food, type: 'combination_breakfast'),
                      ),
                    );
                  },
                  child: Container(
